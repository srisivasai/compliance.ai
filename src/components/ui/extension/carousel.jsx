...
import React, { forwardRef, useCallback, useContext, useEffect, useState, createContext} from "react";
...
const CarouselMainContainer = forwardRef(
  ({ className, dir, children, ...props }, ref) => {
    ...
    return (
      <div {...props} ref={mainRef} className="h-full w-full overflow-hidden" dir={direction}>
        <div
          ref={ref}
          className={cn(
            "flex size-full",
